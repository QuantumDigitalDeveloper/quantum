          ...
          <div className="row">
            <div className="col-lg-5 col-md-12">
              <div className="about__block p_relative">
                ...
                >
                  <Image src="/assets/images/resource/about-us.png" alt="" width={700} height={700} />
                </figure>
                {/* <div
            ...
            <div className="row">
              <div className="col-lg-6 col-md-12">
                <div className="choose__block">
                  <figure>
                    <Image src="/assets/images/resource/choose-01.png" alt="" width={700} height={700} />
                  </figure>
                </div>
              </div>
              <div className="col-lg-6 col-md-12">
      ...
      <div className="pride__section p_relative see__pad">
        ...
        <div className="auto-container">
          <div className="pride__block">
            <figure>
              <Image src="/assets/images/Quantumsedang.png" alt="" width={100} height={100}/>
            </figure>
